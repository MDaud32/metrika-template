    ...
    <div className=" flex flex-col lg:flex-row ">
      <div className="lg:w-1/2 lg:h-screen text-black bg-gray-400 p-10">
        <div className="flex flex-row gap-1 lg:gap-[3rem] justify-center items-center ">
          <div className="lg:text-3xl text-3xl lg:mr-[-10.5rem] lg:ml-[2rem] text-white justify-end mt-1">
            <Link href="/">
              <a>
        ...
        <p className="lg:text-5xl text-3xl md:justify-center lg:justify-center font-light lg:my-28 my-14 lg:ml-16 lg:w-[25rem] flex md:text-left text-center ml-6mx-auto">
      ...
      <div className="lg:w-1/2">
        ...
        <div className="mx-auto my-auto flex flex-col justify-center items-center text-left mt-20 lg:mt-40 gap-10">
          <button className="px-6 py-4 bg-violet-800 text-white my-20 lg:my-40 rounded-md text-xl font-semibold cursor-pointer underline lg:ml-10">
